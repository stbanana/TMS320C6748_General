...
void RK6748_lpscTransition(psc_regs_t *psc, uint32_t in_domain, uint8_t in_module, uint8_t in_next_state);
...
// \return  none.
//-----------------------------------------------------------------------------
void RK6748_pinmuxConfig(uint32_t in_reg, uint32_t in_mask, uint32_t in_val)
{
...
/*
void DumpBuffer(uint8_t *data, uint32_t len)
{
	int i;
